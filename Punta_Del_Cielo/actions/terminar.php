<?php
	...
	if (mysqli_query($link,"INSERT INTO detalle_de_compra (no_productos,id_sucursal,precio_total,fecha) VALUES ($no_productos,$id_sucursal,$precio_total,(SELECT NOW()))")) {

...
<div class="container">
	...
	$result=mysqli_query($link,"SELECT * FROM producto where id_producto=$id");
	...
	while ($row = mysqli_fetch_array($result))
	{
		...
		<input value=\"$id\" type=\"hidden\" name=\"id_producto\" />
		<br>
		Nombre:<br>
		...
		<br>
		Descripcion:<br>
		<input type=\"text\" name=\"descripcion\" value=\"$des\">
		<br>
		Tamaño:<br>
		<input type=\"text\" name=\"tamanio\" value=\"$tam\">
		<br>

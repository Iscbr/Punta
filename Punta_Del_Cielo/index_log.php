...
<!-- Menu -->
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
      		...
      		<li class="active"><a href="index_log.php"> Inicio </a></li>
					<li><a href="worker/productos.php"> Productos </a></li>
					<li><a href="worker/proveedores.php"> Proveedores </a></li>
					<li><a href="worker/sucursales.php"> Sucursales </a></li>
					<li><a href="worker/agregarC.php"> Compra </a></li>
					<li><a href="worker/nosotros.php"> Nosotros </a></li>
		 		</ul>
